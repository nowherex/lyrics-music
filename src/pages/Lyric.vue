      ...
      <div>
        <div class="container">
          ...
          <div class="flex items-center justify-center space-y-8 ">
            <div wire:loading v-if="loading" class="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-gray-700 opacity-75 flex flex-col items-center justify-center">
...
export default {
  ...
  scroll(id) {  
    ...
    async getLyric(id) {
      ...
      const musicAndArtist = `${mus[0].name} ${art.name}` || null
