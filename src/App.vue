      ...
      >
        <div class="max-w-xs sm:max-w-full">
          <h1 class="text-white font-semibold text-3xl mb-2">
            We are award winner top rated lyrics
          </h1>
          <p class="text-selected-light">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae nemo
            sapiente deserunt id ea
          </p>
          <div>
            <button
              class="text-white mt-5 bg-selected-light rounded-full w-32 focus:outline-none hover:bg-primary"
            >
              About
            </button>
          </div>
        ...
        <div class="max-w-xs rounded mb-2">
          ...
          >
            ...
            <path
              ...
              transform="translate(-50.4 -87.11)"
              fill="url(#ad33f4e3-bf33-4b8e-8318-953234af509e)"
            />
            <path
            ...
            <path
              ...
              transform="translate(-50.4 -87.11)"
              fill="url(#af5f6ae9-e1dc-4eac-800c-2506307954c8)"
            />
            <path
          ...
          <div class="flex items-center justify-center">
            ...
            >
              ...
              >
                <div>
                  <img
                    src="https://www.vagalume.com.br/calvin-harris/images/140170.webp"
                    class="rounded max-w-28 max-h-28"
                  />
                  <div class="flex justify-between">
                    <div class="my-2">
                      <p class="font-semibold text-white mb-1">Calvin Harris</p>
                      <p class="text-selected-light">
                        By Your Side (ft. Tom Grennan)
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="flex justify-between">
                  <div class="my-2">
                    <p class="font-semibold text-white mb-1">
                      David Guetta ft. MORTEN & John Martin
                    </p>
                    <p class="text-selected-light">
                      Impossible (With MORTEN, ft. John Martin)
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="flex justify-between">
                  <div class="my-2">
                    <p class="font-semibold text-white mb-1">Dua Lipa</p>
                    <p class="text-selected-light">
                      Love Again
                    </p>
                  </div>
              ...
              >
                ...
                <div class="flex justify-between">
                  <div class="my-2">
                    <p class="font-semibold text-white mb-1">Jxdn</p>
                    <p class="text-selected-light">
                      Think About Me
                    </p>
                  </div>
              ...
              >
                <img
                  src="https://s2.vagalume.com/jax-jones/images/140143.jpg"
                  class="rounded max-w-28 max-h-28"
                />
                <div class="flex justify-between">
                  <div class="my-2">
                    <p class="font-semibold text-white mb-1">Jax Jones</p>
                    <p class="text-selected-light">
                      Feels
                    </p>
                  </div>
